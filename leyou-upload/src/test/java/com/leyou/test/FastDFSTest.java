...
public class FastDFSTest {
    ...
    public void testUpload() throws FileNotFoundException {
        // 要上传的文件
        File file = new File("E:\\code\\timg.jpg");
    ...
    public void testUploadImage() throws FileNotFoundException {
        File file = new File("E:\\code\\1.jpg");
    ...
    @Test
    public void testUploadAndThumbImage() throws FileNotFoundException {
        File file = new File("E:\\code\\timg2.jpg");
        ...
        String thumbImagePath1 = thumbImageConfig.getThumbImagePath(storePath.getPath());
        System.out.println(thumbImagePath);
        System.out.println(thumbImagePath1);
    }
}